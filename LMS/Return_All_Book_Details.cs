...
{
    public partial class Return_All_Book_Details : Form
    {
        ...
        public Return_All_Book_Details()
        {
            InitializeComponent();
        ...
        private void Return_All_Book_Details_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from Issue_Return where Book_Return_Date is not null";
